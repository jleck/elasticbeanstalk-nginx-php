...
ElasticBeanstalk::HostManager::Server.register_post_init_block {
  ...
  if ElasticBeanstalk::HostManager::DeploymentManager.should_deploy(application)
    ...
    ElasticBeanstalk::HostManager.log("Version already deployed. Starting Nginx, Varnish and FPM.")
    ...
    ElasticBeanstalk::HostManager::Utils::BluepillUtil.start_target("varnish")
  end
}
